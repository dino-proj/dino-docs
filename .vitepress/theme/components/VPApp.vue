...
<template>
  <div class="VPApp">
    <VPSkipLink />
    <VTBackdrop class="backdrop" :show="isSidebarOpen" @click="closeSidebar"  v-if="showSidebar"/>
    <slot name="banner" />
    <VPNav />
    <VPLocalNav :open="isSidebarOpen" @open-menu="openSidebar"  v-if="showSidebar"/>
    <VPSidebar :open="isSidebarOpen" v-if="showSidebar">
      <template #top>
